...
import { StarGuard } from './guard/star.guard';
...
const routes: Routes = [
  ...
  { path: PAGES.USERS, component: UserComponent, canActivate: [AuthGuard] },
  { path: PAGES.LOGIN, component: LoginComponent },
  { path: PAGES.ADMIN, component: AdminComponent, canActivate: [AdminGuard] },
  { path: `${PAGES.STARS}/:id`, component: StarsComponent, canActivate: [StarGuard] },
